...
//	public int mesageCounter = 0;
	...
	public Entity npc;
	public int charIndex = 0; //e51
	public String combindeTxt = "";
...
//		messageOn = true;
	...
	public void drawDialogueScreen() {
		...
		//e51
		if(npc.dialogues[npc.dialogSet][npc.dialogueIndex] != null) {
			
//			currentDialogue = npc.dialogues[npc.dialogSet][npc.dialogueIndex];
			
			char character[] = npc.dialogues[npc.dialogSet][npc.dialogueIndex].toCharArray();
			...
			if(charIndex < character.length) {
				...
				combindeTxt = combindeTxt + s;
				currentDialogue = combindeTxt;
				charIndex++;
			}
	...
	public void drawInventory(Entity entity, boolean cursor) {
		...
		for(int i = 0; i < entity.invetory.size(); i++) {
			...
			if(entity.invetory.get(i) == entity.currentWeapon
			   ...
			   entity.invetory.get(i) == entity.currentLight) {
