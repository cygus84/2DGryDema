...
//		worldY = gp.tileSize * 13;
	...
	public int getCurrentWeaponSlot() {
		int currentWeapontSlot = 0;
		for(int i = 0; i < invetory.size(); i++) {
			if(invetory.get(i) == currentWeapon) {
				currentWeapontSlot = i;
			}
		}
		return currentWeapontSlot;
	}
	
	public int getCurrentSheildSlot() {
		int currentWeapontSlot = 0;
		for(int i = 0; i < invetory.size(); i++) {
			if(invetory.get(i) == currentShield) {
				currentWeapontSlot = i;
			}
		}
		return currentWeapontSlot;
