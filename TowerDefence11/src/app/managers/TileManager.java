...
public class TileManager {
	...
	private void createTiles() {
		...
		corners.add(BL_WATER_CORNER = new Tile(ImgFix.buildImgs(getImgs(0, 0, 5, 0)), id++, "BL_Corner"));
		...
		beaches.add(T_WATER = new Tile(ImgFix.buildImgs(getImgs(0, 0, 6, 0)), id++, "T_Water"));
		...
		islands.add(TL_ISLE = new Tile(ImgFix.buildImgs(getImgs(0, 0, 4, 0)), id++, "TL_Isle"));
